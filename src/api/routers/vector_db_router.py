...
def delete_product(
    ...
    service.delete(ids=[str(product_id)])
...
def update_order(
    ...
    order = Order(**order_dto.model_dump())
    service.update_order(order_id, order)
...
def delete_order(
    ...
    service.delete(ids=[str(order_id)])
...
def delete_user(
    ...
    service.delete(ids=[str(user_id)])
...
def search(
    ...
    return service.query(query_texts=[q], top_k=top_k)
